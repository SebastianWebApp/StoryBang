...
export const Read_Story = async (req, res) => {
    ...
    try {
        ...
        const ProcessQueue = new Queue("Read_Story", { redis: redisOptions });
...
export const Delete_Story = async (req, res) => {
    ...
    try {
        ...
        const ProcessQueue = new Queue("Delete_Story", { redis: redisOptions });
