...
describe('Password Recovery', () => {
    ...
    beforeEach(() => {
        ...
        whatsappService.sendPassword = jest.fn();        
    ...
    test('Password sent successfully', async () => {
        const mockJobData = {
            Id: '123',
            Token: 'valid-token',
        };
        ...
        userService.findUserById.mockResolvedValue({
            Phone: 'fdgdfgr',
            Password: 'vp1odfgdrrd'
        });
        whatsappService.sendPassword.mockResolvedValue(true);
        ...
        const sendMessage = await whatsappService.sendPassword(descyptedData.decryptPhone, descyptedData.decryptPassword);      
